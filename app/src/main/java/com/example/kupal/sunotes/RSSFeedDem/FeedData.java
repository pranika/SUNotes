...
import com.example.kupal.sunotes.MainActivityPackage.MyFirebaseRecylerAdapter;
...
public class FeedData {
    ...
    public FeedData(){
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("feed").getRef();
