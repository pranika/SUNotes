...
public class officedata {
    ...
    officehouradaptar myFirebaseRecylerAdapter;
    public Context mContext;

    public void setAdapter(officehouradaptar mAdapter) {
    ...
    public officedata(){
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Officehour").getRef();
