...
public class deadlinedata {
    ...
    deadlineAdaptar myFirebaseRecylerAdapter;
    public Context mContext;

    public void setAdapter(deadlineAdaptar mAdapter) {
    ...
    public deadlinedata(){
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Deadline").getRef();
