...
public class CourseData {
    ...
    CourseFireBaseRecyclerAdaptar myFirebaseRecylerAdapter;
    public Context mContext;

    public void setAdapter(CourseFireBaseRecyclerAdaptar mAdapter) {
    ...
    public CourseData(){
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Course").getRef();
