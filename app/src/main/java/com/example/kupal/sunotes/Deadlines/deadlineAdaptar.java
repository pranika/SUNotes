...
public class deadlineAdaptar extends FirebaseRecyclerAdapter<FeedItem, deadlineAdaptar.FeedViewHolder> {

    private Context mContext;
    private static deadlineAdaptar.RecyclerItemClickListener mItemClickListener;
    ...
    public void setOnItemClickListener(final deadlineAdaptar.RecyclerItemClickListener mItemClickLisn){
        mItemClickListener = mItemClickLisn;
    }


    public deadlineAdaptar(Class<FeedItem> modelClass, int modelLayout,
                                         Class<deadlineAdaptar.FeedViewHolder> holder, DatabaseReference ref, Context context) {
    ...
    @Override
    protected void populateViewHolder(deadlineAdaptar.FeedViewHolder holder, FeedItem feed, int i) {
    ...
    @Override
    public deadlineAdaptar.FeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View newView;
        newView = LayoutInflater.from(parent.getContext()).inflate(mModelLayout, parent, false);
        return new deadlineAdaptar.FeedViewHolder(newView);
    }
