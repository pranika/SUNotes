package com.example.kupal.sunotes.MainActivityPackage; //change the package name to your project's package name
...
public class MyFirebaseRecylerAdapter extends FirebaseRecyclerAdapter<FeedItem, MyFirebaseRecylerAdapter.FeedViewHolder> {
    ...
    public MyFirebaseRecylerAdapter(Class<FeedItem> modelClass, int modelLayout,
                                    Class<FeedViewHolder> holder, DatabaseReference ref, Context context) {
    ...
    @Override
    protected void populateViewHolder(FeedViewHolder holder, FeedItem feed, int i) {
    ...
    public FeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new FeedViewHolder(newView);
    }
